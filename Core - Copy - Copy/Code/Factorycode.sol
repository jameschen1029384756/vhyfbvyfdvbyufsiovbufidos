...
contract Factorycode is IUniswapV2Factory {
...
return "1";
    ...
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(Paircode).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(Paircode).creationCode;
    ...
    function setFeeTo(address _feeTo) external {
        require(_msgSender() == feeToSetter, 'Swap: FORBIDDEN');
        feeTo = _feeTo;
    }
